...
import {getPagination, getUserId, MOVIE_SORT, RATING_SORT} from '../utils.js'
...
router.get('/:id/similar', async (req, res, next) => {
  try {
    ...
    const movie = await recommendationService.getSimilarMovies(req.params.id, limit, skip, userId)
